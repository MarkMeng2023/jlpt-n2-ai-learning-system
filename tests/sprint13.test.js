...
const sprint13Questions = questions.filter((question) => !question.questionId.startsWith("Q-N2-FAC-S14-") && !question.questionId.startsWith("Q-N2-FAC-S15-") && !question.questionId.startsWith("Q-N2-FAC-S16-") && !question.questionId.startsWith("Q-N2-FAC-S17-"));
...
test("首页包含可展开的 N2 考试覆盖率 Dashboard", async () => {
  ...
  assert.match(html, /styles\/main\.css\?v=1\.17\.0/);
  assert.match(html, /src\/app\.js\?v=1\.17\.0/);
});
